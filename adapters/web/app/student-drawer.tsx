...
import { CO_COLORS, T, mono, sora, type Offering, type Student, type StudentHistoryRecord } from '@web/simulation/fixtures'
import { toTodayISO, type AcademicMeeting, type Role, type TaskType } from '@kernel/shared/domain'
import { minutesToDisplayLabel } from '@web/shared/state/calendar-utils'
import { useAppSelectors } from '@web/shared/state/selectors'
import { Bar, Btn, Chip, UI_TRANSITION_FAST, UI_TRANSITION_MEDIUM } from '@web/shared/ui/primitives'
import { type StudentCheckpointCoreMetrics } from '@web/features/academic/student-checkpoint-parity'
import {
  buildHistoryProfile,
