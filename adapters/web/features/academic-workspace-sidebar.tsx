...
import { T, mono, sora, type YearGroup } from '@web/simulation/fixtures'
import type { FacultyAccount, Role } from '@kernel/shared/domain'
import { Bar, withAlpha } from '@web/shared/ui/primitives'
