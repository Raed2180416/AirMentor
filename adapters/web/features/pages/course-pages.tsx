...
import { CO_COLORS, CO_MAP, T, mono, sora, yearColor, type CODef, type CoAttainmentRow, type Offering, type Student, type StudentHistoryRecord } from '@web/simulation/fixtures'
import type {
  EntryKind,
  EntryLockMap,
  RiskBand,
...
import { TAB_DEFS, clampNumber } from '@web/shared/state/page-utils'
import { Bar, Btn, Card, Chip, HScrollArea, PageBackButton, PageShell, RiskBadge, TD, TH, getSegmentedButtonStyle, getSegmentedGroupStyle } from '@web/shared/ui/primitives'
