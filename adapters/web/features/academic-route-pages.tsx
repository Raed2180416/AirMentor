...
import { T, mono, sora, yearColor, type Mentee, type Offering, type Student, type StudentHistoryRecord, type YearGroup } from '@web/simulation/fixtures'
import { type EntryKind, type RiskBand, type Role, type SharedTask } from '@kernel/shared/domain'
...
import { Bar, Btn, Card, Chip, PageBackButton, PageShell, StagePips, withAlpha } from '@web/shared/ui/primitives'
