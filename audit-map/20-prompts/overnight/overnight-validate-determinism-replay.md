...
Overnight Validate: Deterministic Replay. Execute the specified validation layer, capture outputs, report pass/fail against auth-prompt gate M.
...
# run replay scripts if env supports it; else document scripted dry-run proof paths
            ```
