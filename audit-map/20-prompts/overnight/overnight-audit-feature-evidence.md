...
Deep audit: Overnight Audit: Feature / Evidence / Runtime Correctness. Per-file findings table — expected vs current code truth (file:line) — with target-phase and severity.
