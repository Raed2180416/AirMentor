...
| --- | --- | --- | --- | --- | --- |
| L-01 | `concernContextKey` literal | Open drift | `audit-map/14-reconciliation/contradiction-matrix-queue-calendar.md`<br>`air-mentor-api/src/lib/proof-queue-governance.ts` | `rg -n "concernContextKeyForCandidate" air-mentor-api/src/lib` | `air-mentor-api/src/lib/proof-queue-governance.ts:147-156`, `audit-map/20-prompts/fresh-sem1-principal-architect-overnight-pass.md:188` |
...
| L-03 | Workflow Category Separation | Resolved in code | `audit-map/32-reports/overnight-reconcile-queue-calendar.md` | `rg -n "approval-unlock|escalation-review" air-mentor-api/src/lib` | `air-mentor-api/src/lib/proof-queue-governance.ts:19-20`, `audit-map/20-prompts/fresh-sem1-principal-architect-overnight-pass.md:198-203` |
