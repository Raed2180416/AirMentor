...
| Demo isolation regression test (global rows untouched) | partial — backend schema/reset/session-pointer/scoped-bootstrap/proof-run activation regressions and frontend pointer/header tests covered; full browser walkthrough pending | H1 → P5/P9 |
