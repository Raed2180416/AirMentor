  ...
  it('renders proof-backed model provenance, trained heads, and bounded counterfactual copy', () => {
    const props: ComponentProps<typeof RiskExplorerPage> = {
      ...
      initialExplorer: {
        ...
        cgpaTrace: {
          formulaSource: 'grading-formula-config.ts',
          ceWeights: { tt1: 0.25, tt2: 0.25, quiz: 0.25, assignment: 0.25 },
          passRules: { ceMinimum: 40, seeMinimum: 40, overallMinimum: 40 },
          terms: [{
            semesterNumber: 5,
            storedSgpa: 6.9,
            recomputedSgpa: 6.9,
            storedCgpaAfterSemester: 6.8,
            recomputedCgpaAfterSemester: 6.8,
      ...
      initialExplorer: {
        ...
        cgpaTrace: {
          ...
          terms: [{
            ...
            storedSgpa: 7.8,
            recomputedSgpa: 7.8,
            storedCgpaAfterSemester: 7.8,
            recomputedCgpaAfterSemester: 7.8,
      ...
      initialExplorer: {
        ...
        cgpaTrace: {
          ...
          terms: [{
            ...
            storedSgpa: 6.9,
            recomputedSgpa: 6.9,
            storedCgpaAfterSemester: 6.9,
            recomputedCgpaAfterSemester: 6.9,
            registeredCredits: 22,
            earnedCredits: 18,
            backlogCount: 1,
            subjects: [],
      ...
      initialExplorer: {
        ...
        cgpaTrace: {
          ...
          terms: [{
            ...
            storedSgpa: 7.4,
            recomputedSgpa: 7.4,
            storedCgpaAfterSemester: 7.2,
            recomputedCgpaAfterSemester: 7.2,
            registeredCredits: 22,
            earnedCredits: 18,
            backlogCount: 0,
            subjects: [],
        ...
        counterfactual: null,
        electiveFit: {
          recommendedCode: 'MC6E02',
          recommendedTitle: 'Advanced Topics',
          stream: 'Data Intelligence',
          rationale: ['Stable advanced signal'],
          alternatives: [],
        },
      },
      initialTab: 'advanced',
