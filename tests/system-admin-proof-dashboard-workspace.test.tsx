...
describe('SystemAdminProofDashboardWorkspace', () => {
  ...
  it('routes reset-from-scratch through the baseline snapshot action instead of playback reset', () => {
    const onResetProofRunFromScratch = vi.fn()
    const selectedCheckpoint = buildCheckpoint({
      simulationStageCheckpointId: 'checkpoint_sem1',
      semesterNumber: 1,
      stageLabel: 'Semester 1',
      stageKey: 'semester-open',
      stageOrder: 1,
      previousCheckpointId: null,
      nextCheckpointId: null,
      playbackAccessible: true,
    ...
    render(createElement(SystemAdminProofDashboardWorkspace, {
      proofDashboard: {
        ...
        activeRunDetail: {
          ...
          snapshots: [
            {
              simulationResetSnapshotId: 'snapshot_baseline',
              snapshotLabel: 'Baseline snapshot',
              createdAt: '2026-03-16T00:00:00.000Z',
              payload: {},
            },
        ...
        lifecycleAudit: [],
        recentOperationalEvents: [],
      } as unknown as ApiProofDashboard,
      proofDashboardLoading: false,
      activeRunCheckpoints: [selectedCheckpoint],
      activeModelDiagnostics: null,
      activeProductionDiagnostics: null,
