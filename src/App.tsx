...
export { RequiredNoteModal } from './app/required-note-modal'
export { TaskComposerModal } from './app/task-composer-modal'
export { StudentDrawer } from './app/student-drawer'
export { ActionQueue } from './app/action-queue'
import { OperationalWorkspace } from './app/operational-workspace'
import type { AcademicWorkspaceProjection } from './app/workspace-types'
import {
