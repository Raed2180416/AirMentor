...
import { createAirMentorRepositories } from './repositories'
...
export default function App() {
  const repositoryMode = import.meta.env.VITE_AIRMENTOR_REPOSITORY_MODE === 'http' ? 'http' : 'local'
  if (repositoryMode === 'http') return <SystemAdminApp />
