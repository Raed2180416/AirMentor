...
- The accessibility issue remains only partially open because:
  - there is still no screen-reader-focused verification
...
- Keyboard-flow testing, live axe/browser checks, and live accessibility-tree assertions now exist for high-risk portal, admin, proof, dialog, and teacher proof paths, but screen-reader testing is still absent.
