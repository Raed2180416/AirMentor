...
| `/home/raed/projects/air-mentor-ui/src/system-admin-live-app.tsx` | System-admin live control plane shell | Active runtime | Yes | Still a large hotspot, but overview scoped-count computation is now delegated into extracted helpers and the root is increasingly just route/workspace wiring plus shell integration | `AM-001`, `AM-002`, `AM-014` |
| `/home/raed/projects/air-mentor-ui/src/academic-session-shell.tsx`, `/home/raed/projects/air-mentor-ui/src/academic-route-pages.tsx`, `/home/raed/projects/air-mentor-ui/src/academic-faculty-profile-page.tsx`, `/home/raed/projects/air-mentor-ui/src/academic-proof-summary-strip.tsx`, `/home/raed/projects/air-mentor-ui/src/academic-workspace-route-helpers.ts`, and related academic workspace shells | Academic route/session shell decomposition | Active runtime | Yes | The academic shell layer now owns session gating, route composition, extracted faculty-profile parity, and the shared proof-summary strip outside `App.tsx`, keeping the monolith closer to a thin integration hook | `AM-001`, `AM-005`, `AM-009` |
| `/home/raed/projects/air-mentor-ui/src/system-admin-session-shell.tsx`, `/home/raed/projects/air-mentor-ui/src/system-admin-proof-dashboard-workspace.tsx`, `/home/raed/projects/air-mentor-ui/src/system-admin-request-workspace.tsx`, `/home/raed/projects/air-mentor-ui/src/system-admin-history-workspace.tsx`, `/home/raed/projects/air-mentor-ui/src/system-admin-hierarchy-workspace-shell.tsx`, `/home/raed/projects/air-mentor-ui/src/system-admin-faculties-workspace.tsx`, `/home/raed/projects/air-mentor-ui/src/system-admin-overview-helpers.ts` | System-admin shell/workspace decomposition | Active runtime | Yes | Extracted workspace and helper boundaries now cover request/history UI ownership plus pure overview scoped-count logic, reducing monolith coupling while keeping deep-link behavior testable | `AM-001`, `AM-009`, `AM-014` |
...
| `/home/raed/projects/air-mentor-ui/src/system-admin-live-data.ts` | Admin selectors, visibility, search shaping | Active runtime | Yes | Scope and visibility logic lives partly here instead of one centralized policy layer; registry filter hydration and latest enrollment/mentor helpers are now extracted here as pure admin data utilities | `AM-004`, `AM-014` |
...
| `/home/raed/projects/air-mentor-ui/air-mentor-api/src/modules/` | Route modules | Active runtime | Yes | Route ownership is now split more explicitly across `academic-*.ts` modules plus `academic-access.ts`; `students.ts` and `people.ts` now also carry section-aware student/faculty provenance and human-readable admin label enrichment | `AM-001` through `AM-016` |
