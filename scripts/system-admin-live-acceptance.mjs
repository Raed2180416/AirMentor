...
try {
  ...
  await page.getByRole('button', { name: 'Edit Faculty', exact: true }).evaluate(button => button.click())
  ...
  await page.getByRole('button', { name: 'Edit Department', exact: true }).evaluate(button => button.click())
  ...
  await page.getByRole('button', { name: 'Edit Branch', exact: true }).evaluate(button => button.click())
  ...
  await page.getByRole('button', { name: 'Edit Batch', exact: true }).evaluate(button => button.click())
